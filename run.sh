...
# SGD 
python3 main_torch.py --batch_size 1 --init_weight_type "simple" --exp_id "exp3_sgd" --grad_clip --grad_clip_value 10.0 --lr 0.0001 --simple_init_std 1.0 --weight_decay 0.01

# SGD w/ noise
python3 main_torch.py --batch_size 1 --grad_noise --eta 0.01 --gamma 0.55 --init_weight_type "simple" --exp_id "exp3_sgd_noise" --grad_clip --grad_clip_value 10.0 --lr 0.0001 --simple_init_std 1.0 --weight_decay 0.01
