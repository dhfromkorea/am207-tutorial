...
for eta in eta_list:
    ...
    for t in range(num_epoch):
        ...
        # print("Normal SGD Current t : ",t," Current Error: ", normal_sgd_error,end=' ')
        ...
        w1_normal = w1_normal - lr*grad_1

        w2_normal = w2_normal - lr*grad_2

        w3_normal = w3_normal - lr*grad_3

        w4_normal = w4_normal - lr*grad_4
    ...
    print("Final Error for Normal SGD Current t: ",t,"  Error: ", np.round(normal_sgd_error,4))
    ...
    for t in range(num_epoch):
        ...
        # print("Additive Current t : ",t," Current Error: ", ADDITIVE_sgd_error,end='\r')
        ...
        ADDITIVE_NOISE_STD = eta / (np.power((1 + t), gamma))
        ...
        w1_additive = w1_additive - lr*(grad_1+ ADDITIVE_GAUSSIAN_NOISE)

        w2_additive = w2_additive - lr*(grad_2+ ADDITIVE_GAUSSIAN_NOISE)

        w3_additive = w3_additive - lr*(grad_3+ ADDITIVE_GAUSSIAN_NOISE)

        w4_additive = w4_additive - lr*(grad_4+ ADDITIVE_GAUSSIAN_NOISE)


        #if t % 500 == 0:
        #    print("t{}".format(t))

    print("Final Error for Additive SGD Current t: ",t,"  Error: ", np.round(ADDITIVE_sgd_error,4))
